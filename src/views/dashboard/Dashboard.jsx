    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-white border rounded shadow p-4 h-80">
          <h2 class="text-lg font-bold mb-3">{t("Weekly Visitors")}</h2>
        ...
        {/* Today Visits */}
        <div className="bg-white border rounded shadow p-4 h-80">
          <h2 class="text-lg font-bold mb-3">{t("Today's Visitors")}</h2>
          <div className="h-64 p-4">
            <Line
              data={lineChartData}
        ...
        <div className="bg-white border rounded shadow p-4 h-80">
          <h2 class="text-lg font-bold mb-3">{t("People in Zones")}</h2>
          <div className="h-64 p-4">
            <Doughnut
            ...
            <table className="min-w-full">
              <thead>
                <tr className="text-left">
                  <th className="px-2 pb-2 text-center">{t("Image")}</th>
                        ...
                        <div className="flex justify-center">
                          <div className="inline-block h-16 w-16 border-2 border-gray-300 rounded-full overflow-hidden bg-customGreen">
                            {visitor.visitor_image ? (
                              <img
                                src={`data:image/jpeg;base64,${visitor.visitor_image}`}
                                alt="User"
                              />
                            ) : (
