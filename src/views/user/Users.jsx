...
const Users = ({ users, isLoading, onActionClick ,fetchData }) => {
  ...
  const handelDeletee = async (id) => {
    const response = await fetch(
      `${url}/accounts/update-user/${id}/`,
        {
          method: "PATCH",
          headers: {
      ...
      if (response.ok) {
        Notification.showSuccessMessage("Success", "User Deleted Successfully");
      } else {
  ...
  const confirmDelete = () => {
    ...
    handelDeletee(currentSelectedUser.id)
