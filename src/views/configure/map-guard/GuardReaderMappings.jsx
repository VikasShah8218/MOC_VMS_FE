...
const GuardReaderMappings = () => {
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const response = await fetch(`${url}/gadgets/map-reader-guard`, {
                method: "GET",
                headers: {
                    ...
                    <table className="text-left w-full border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{t("Adam")} {t("Name")}</th>
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{t("Zone")} {t("Name")}</th>
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{t("Users")}</th>
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{t("Moxa")} {t("IP")}</th>
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{t("Reader")} {t("Type")}</th>
                                <th className="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">{t("COM")} {t("Port")}</th>
                            </tr>
                        </thead>
                        <tbody>
